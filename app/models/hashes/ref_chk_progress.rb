class RefChkProgress < ActiveHash::Base
  ...
  self.data = [
    ...
    { id: 2, title: '質問テンプレート設定ずみ', progress: 'question_template_setted' },
    ...
    { id: 6, title: '推薦者一部回答', progress: 'recommender_answered' },
    { id: 7, title: '推薦者回答ずみ', progress: 'all_recommender_answered' },
